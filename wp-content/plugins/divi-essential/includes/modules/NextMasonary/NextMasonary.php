...
class Next_Masonary extends ET_Builder_Module {
    ...
    public function render($attrs, $content, $render_slug) {
        ...
        if('off' !== $this->props['use_overlay']) {
			...
			$hover_icon_tablet = isset($icon_fontawesome_tablet[0]) ? $icon_fontawesome_tablet[0] : $hover_icon;
			$hover_icon_weight_tablet = isset($icon_fontawesome_tablet[2]) ? $icon_fontawesome_tablet[2] : $hover_icon_weight;
			$hover_icon_phone = isset($icon_fontawesome_phone[0]) ? $icon_fontawesome_phone[0] : $hover_icon_tablet;
        ...
        $output .= sprintf('<div class="dnxte-grid"><div class="dnxte-msnary-grid" data-lightbox="%2$s" data-gutter="%1$s"><div class="grid-sizer"></div><div class="gutter-sizer"></div>', $this->props['dnxte_gutter'], $lightbox_on_off);
    ...
    public function dnxte_apply_css($render_slug) {
        ...
        $icon_size_style = sprintf('font-size: %1$spx;width: %2$spx;height:%2$spx;line-height:%2$spx;', $icon_size, $icon_area);
        $icon_size_style_tablet = sprintf('font-size: %1$spx;width: %2$spx;height:%2$spx;line-height:%2$spx;', $icon_size_tablet, $icon_area_tablet);
        $icon_size_style_phone = sprintf('font-size: %1$spx;width: %2$spx;height:%2$spx;line-height:%2$spx;', $icon_size_phone, $icon_area_phone);
