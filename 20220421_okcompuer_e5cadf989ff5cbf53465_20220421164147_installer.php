...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220421_okcompuer_e5cadf989ff5cbf53465_20220421164147_archive.zip';
	const ARCHIVE_SIZE		 = '84247664';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'e5cadf9-21164147';
    const SECONDARY_PACKAGE_HASH = '19b0620-21164147';
	const VERSION			 = '1.4.5';
